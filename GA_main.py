...
def main():
    ...
    parser_struct.add_argument("--residues_to_mute", type=int, nargs='+', required=True, help="List of residue indices (PDB numbering) to  mutate")
    ...
    parser_seq.add_argument("--residues_to_mute", type=int, nargs='+', required=True, help="List of residue indices to  mutate")
